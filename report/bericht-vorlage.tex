...
-scatterplot: bild, achsen, datenpunkte
-anforderungserfüllung: design einfach gehalten ->
	einfarbig,
	die 2 hauptdim,
	x-ray vermittelt auf den ersten blick gefühl für dichte durch Helligkeit (Überlagerungen) -> genaue dichte nicht ablesbar (ab gewisser dichte sehen konflikthäufungen sehr ähnlich aus: "Ein linearer Anstieg des Helligkeitsstimulus korrespondiert nur zu einem sublinearen Zuwachs an wahrgenommener Helligkeit."),
	räumliche spaltentrennung vermittelt jahreszusammengehörigkeit (S2S136)
-alternativen: log opfer skala für bessere verteilung der datenpunkte
	-> starke überlappung (xray effekt) geht verloren -> höheres augenmerk auf einzelne datenpunkte und nicht gruppierungen -> gut: genauer opferzahlen ablesen, schlecht: weniger gefühl für konfliktdichte
