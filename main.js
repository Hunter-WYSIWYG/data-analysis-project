...
var $author$project$Main$filterConflictForCountries = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(conflict.notes)
						]))
				]));
	});
...
var $author$project$Scatterplot$scatterplot = F2(
	function (conflictsForAxes, filteredConflicts) {
		var yValues = A2(
			$elm$core$List$map,
			function (c) {
				return c.fatalities;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Scatterplot$padding - 1, $author$project$Scatterplot$padding - 1)
								])),
							$elm_community$typed_svg$TypedSvg$Attributes$fontSize(
							$elm_community$typed_svg$TypedSvg$Types$Px(15.0)),
							$elm_community$typed_svg$TypedSvg$Attributes$fontFamily(
					...
					[
						...
						_List_fromArray(
							[
								...
								model.conflicts,
								A2($author$project$Main$filterConflictForCountries, model.conflicts, model.scatterplotCountries))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Conflict.Conflict":{"args":[],"type":"{ event_id_no_cnty : Basics.Int, year : Basics.Int, fatalities : Basics.Int, notes : String.String, country : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GotData":["Result.Result Http.Error (List.List Conflict.Conflict)"],"UpdateSPCountries":["String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));